...
def e156():
 i=156;z=F[i][2];w=W(i);_,p=nd(w,F[i][0],"北宋景德二年十月十五日","官职");ac(w,"Timepoints",p,i,z,"补充文臣、内侍充任及总辖本司公事。",note="职掌与充任");_,o=nd(w,"都大提举在京诸司库务司","北宋景德二年十月十五日","机构");rl(w,o,p,"编制隶属",i,z,"主管官掌总辖本司公事。",staff_quota=2,staff_type="官");w.commit()
def e157():
